package com.rishab.concurrencyExtras;
...
// Using AtomicInteger instead of synchronized method
...
//        StudentId idGenerator = new StudentId();
        ...
        Callable<Student> studentMaker = () -> {
            ...
            Student student = new Student("Yoda " + studentId, random.nextInt(2018, 2025), studentId);
